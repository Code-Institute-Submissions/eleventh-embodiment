...
Originally the idea was to have a "Home" page for general information about the page and clarification on the name. "About" page would have information about the owner and their pictures. 
...
- Currently, the contact forms do not send any information so site owner is not collecting any information about users as of yet 
...
Testing was planned to be completed in a few stages: 
...
1. "The document is not mappable to XML 1.0 due to two consecutive hyphens in a comment"\
    The solution was found [here](https://www.experts-exchange.com/questions/28661509/The-document-is-not-mappable-to-XML-1-0-due-to-two-consecutive-hyphens-in-a-comment.html)
...
4. The following Browsers were tested:
   ...
   - Safari
   - Opera\
   Testing was done in the following manner - I opened the website url in each browser and then opened the inspector to be able to resize down 
   to the 320px to make sure that all pages are responsive.
...
2. I want to learn more about the site owner and their skills and offering
   ...
   When user gets to the Home page they can immediately see site owners story and their skills and experience.\
   Under that, they can see the section with the methods the site owner uses in her practice and they can click a button to learn more.\
   "Learn More" button when clicked leads to the "What I Do" page where the user can find our more inforamtion about each of the methods site owner uses.
...
- There was a need to align the images and text depending on the screen size, which was accomplished with a combination of Bootstrap grid and media queries
- There was a horizontal scroll on some screens which was removed by using overflow-x: hidden.
